(function() {
  ...
  $(function() {
    var Defaults, Modules, Sidebar, SidebarView;
    Defaults = {};
    Defaults.Instrument = {
      Note: {
        'a': 220,
    ...
    Modules.Instrument = (function() {
      ...
      _Class.prototype.initialize = function() {
        this.gui = new DAT.GUI;
        this.gui.add(this.attributes, 'note').options(Defaults.Instrument.Note);
        return this.gui.add(this.attributes, 'length').min(Defaults.Instrument.Length.min).max(Defaults.Instrument.Length.max);
      };
      return _Class;
    })();
    Modules.Sample = (function() {
      ...
      _Class.prototype.initialize = function() {
        var controller;
        this.gui = new DAT.GUI;
        controller = this.gui.add(this.attributes, 'sample');
        controller.options.apply(controller, Defaults.Sample.Sample);
        this.gui.add(this.attributes, 'pitch').min(Defaults.Sample.Pitch.min).max(Defaults.Sample.Pitch.max);
        return this.gui.add(this.attributes, 'offset').min(Defaults.Sample.Offset.min).max(Defaults.Sample.Offset.max);
      };
      return _Class;
    })();
    Sidebar = (function() {
    ...
    SidebarView = (function() {
      ...
      _Class.prototype.initialize = function() {
        ...
        return $('.module', this.el).each(function() {
          ...
          return module.bind('change:closed', function(module, closed) {
            return $module[!closed ? 'addClass' : 'removeClass']('open');
          });
        });
      };
      _Class.prototype.toggle_content = function(e) {
        var $module, active, model;
