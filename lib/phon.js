(function() {
  ...
  $(function() {
    var Modules, Options, Sidebar, SidebarView;
    Modules = {};
    ...
    Modules.Instrument = (function() {
      ...
      _Class.prototype.initialize = function() {
        this.gui = new DAT.GUI;
        this.gui.add(this.attributes, 'note').options(Options.Instrument.Note);
        return this.gui.add(this.attributes, 'length').min(Options.Instrument.Length.min).max(Options.Instrument.Length.max);
      };
      return _Class;
    })();
    Modules.Sample = (function() {
      ...
      _Class.prototype.initialize = function() {
        ...
        this.gui.add(this.attributes, 'pitch').min(Options.Sample.Pitch.min).max(Options.Sample.Pitch.max);
        return this.gui.add(this.attributes, 'offset').min(Options.Sample.Offset.min).max(Options.Sample.Offset.max);
      };
      return _Class;
    })();
    Sidebar = (function() {
