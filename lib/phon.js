(function() {
  var Cell, NUM_COLS, NUM_ROWS, Particle, StateHash, cell_colors, cells, collide, decays, doLoop, init, iterate, log, occupied, particle_color, particles;
  ...
  Raphael.fn.octogrid = function(x, y, rows, cols, width) {
    ...
    Oct = (function() {
      ...
      Oct.prototype.onClick = function(evt) {
        return log(cells["" + this.row + "_" + this.col + "_1"]);
      };
  ...
  iterate = function() {
    var cell, cellIndex, index, particle, toKill, _len, _ref;
    occupied.reset();
    toKill = [];
  ...
  $(function() {
    var Module, Modules, _ref;
    if ((_ref = window.Phon) == null) {
      window.Phon = {};
    }
    Module = (function() {
    ...
    Modules.Global = (function() {
      ...
      _Class.prototype.initialize = function() {
        ...
        return this.gui.add(window.Phon.Properties, 'tick').min(0).max(300);
      };
      return _Class;
    })();
    window.Sidebar = (function() {
      ...
      _Class.prototype.initialize = function() {
        ...
        return $('.module', this.el).each(function() {
          ...
          return $('.content', $module).append(module.gui.domElement);
        });
      };
      _Class.prototype.toggle_content = function(e) {
        var $module, closed, model;
        $module = $(e.target).closest('.module');
        model = $module.data('model');
        closed = model.get('closed');
        $('.icon', $module).text(closed ? "-" : "+");
        $('.content', $module)[closed ? "show" : "hide"]();
        return model.set({
          'closed': !closed
        });
      };
