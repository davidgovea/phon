(function() {
  var Cell, NUM_COLS, NUM_ROWS, Particle, StateHash, cell_colors, cells, collide, decays, doLoop, init, iterate, log, occupied, particle_color, particles, _ref;
  ...
  iterate = function() {
    var cell, cellIndex, index, particle, toKill, _len, _ref2;
    occupied.reset();
    toKill = [];
    ...
    _ref2 = occupied.h;
    for (cellIndex in _ref2) {
      cell = _ref2[cellIndex];
      if (cell.state === 1) {
        if (cell.split) {} else {
